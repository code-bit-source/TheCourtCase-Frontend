        ...
        return (
          <div>
            ...
            <SettingRow label="Two-Factor Authentication" desc="Add an extra layer of security">
              <button onClick={() => addNotification('info', '2FA setup initiated. Check your email for instructions.')} style={{ padding: '10px 20px', fontSize: 14, border: `1px solid ${accentColor}`, borderRadius: 8, backgroundColor: colors.accentLight, cursor: 'pointer', color: accentColor, fontWeight: 500 }}>
                Enable 2FA
              </button>
            </SettingRow>
            ...
            <div style={{ marginTop: 32, padding: 20, backgroundColor: isDark ? 'rgba(235,77,61,0.1)' : 'rgba(235,77,61,0.05)', borderRadius: 12, border: '1px solid rgba(235,77,61,0.2)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                ...
                <button onClick={() => addNotification('warning', 'Account deletion request sent. Check your email for confirmation.')} style={{ padding: '10px 20px', fontSize: 14, border: '1px solid #eb4d3d', borderRadius: 8, backgroundColor: colors.card, cursor: 'pointer', color: '#eb4d3d', fontWeight: 500 }}>
                  Delete
                </button>
              </div>
            </div>
