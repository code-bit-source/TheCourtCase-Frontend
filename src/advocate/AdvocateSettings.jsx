            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 20, padding: '24px 0', borderBottom: `1px solid ${colors.borderLight}` }}>
              <div style={{ position: 'relative' }}>
                <div style={{ width: 80, height: 80, borderRadius: '50%', overflow: 'hidden', border: `3px solid ${accentColor}` }}>
                  <img src={user?.avatar || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop"}  alt="Profile" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
              ...
              <div>
                <p style={{ fontSize: 20, fontWeight: 600, color: colors.text, margin: 0 }}>{displayName}</p>
                <p style={{ fontSize: 14, color: colors.textSecondary, margin: '4px 0 0 0' }}>{email}</p>
    ...
    <ThemeContext.Provider value={{ theme, setTheme, accentColor, setAccentColor, isDark }}>
      <div className="settings-page" style={{ display: 'flex', flexDirection: 'column', height: '100vh', width: '100%', overflow: 'hidden', backgroundColor: colors.bg, color: colors.text }}>
        ...
        <nav className="mobile-bottom-nav">
          <Link to="/"><LayoutDashboard size={20} /><span>Home</span></Link>
          <Link to="/tasks"><ListTodo size={20} /><span>Tasks</span></Link>
          <Link to="/billing"><CreditCard size={20} /><span>Billing</span></Link>
          <Link to="/settings" className="active"><Settings size={20} /><span>Settings</span></Link>
        </nav>
