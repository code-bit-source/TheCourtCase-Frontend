      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto max-w-[1100px] px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-[32px] font-bold mb-6">Send us a message</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-[16px] font-medium mb-2">
                    Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="subject" className="block text-[16px] font-medium mb-2">
                    Subject
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="message" className="block text-[16px] font-medium mb-2">
                    Message
                  </label>
                  <textarea
                    id="message"
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white px-6 py-4 rounded-lg hover:bg-blue-700 transition-colors font-semibold text-[16px]"
                >
                  Send Message
                </button>
              </form>
            ...
            {/* Contact Information */}
            <div>
              <h2 className="text-[32px] font-bold mb-6">Contact Information</h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[20px] font-semibold mb-2">Email</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[20px] font-semibold mb-2">Office</h3>
                    <p className="text-[16px] text-[#666666]">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[20px] font-semibold mb-2">Support</h3>
                    <p className="text-[16px] text-[#666666]">
                      Visit our{' '}
                      <a href="/help-center" className="text-[#617fdf] hover:underline">
                        Help Center
                      </a>
                      {' '}for instant answers
                    </p>
